...
# #This script computes penetrance estimates for pLoFs using a simple beta-binomial model. However, estimates now incorporate both diagnosis and symptome-driven expression measurements.
...
output_table.to_pickle('/Path/to/Symptom/Penetrance/Results/CombinedSymptomDxPenetrance.pth')
output_table.to_csv('/Path/to/Symptom/Penetrance/Results/CombinedSymptomDxPenetrance.txt',sep='\t')
