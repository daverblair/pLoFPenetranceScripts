...
combined_expression_table = pd.read_pickle('/Users/davidblair/Desktop/Research/PDS_Project/Analysis/13_BuildCombinedPenetranceDataset/UKBB/Results/GlobalPenetranceTable.pth')
ehr_flags = pd.read_pickle('/Users/davidblair/Desktop/Research/PDS_Project/Analysis/14_EHRCoverageBias/UKBB/Results/UKBB_LowEHRDataFlags.pth')
...
output_table.to_pickle('../Results/CombinedDxSymptomsPPV_EHRCoverageFiltered.pth')
output_table.to_csv('../Results/CombinedDxSymptomsPPV_EHRCoverageFiltered.txt',sep='\t')
