...
master_table=pd.read_pickle('../VariantData/AllHaploLOFVariants/AllHaploLOFVariants_NoScores.pth')
...
vcf_file=VCF('../VariantData/AllHaploLOFVariants/VCFs/AllHaploLOFVariants_wSamples_Sorted.vcf.gz')
header_id_dict={}
...
variant_table.to_pickle('../VariantData/AllHaploLOFVariants/AllHaploLOFVariants_FilteredCarriers.pth')
...
variant_table_txt.to_csv('../VariantData/AllHaploLOFVariants/AllHaploLOFVariants_FilteredCarriers.txt',sep='\t')
